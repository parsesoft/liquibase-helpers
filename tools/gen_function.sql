...
+ ' dbms:mssql'
+ CHAR(13)
+ CHAR(13) + 'IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N''' + @qualified_name + ''') AND type in (N''FN'', N''IF'', N''TF'', N''FS'', N''FT''))'
+ CHAR(13) + 'DROP FUNCTION ' + @qualified_name
+ CHAR(13) + 'GO'
+ CHAR(13)
